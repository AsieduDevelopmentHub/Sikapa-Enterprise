  ...
  return (
    <div>
      ...
      <div className="relative mt-1">
        ...
        <button
          type="button"
          className="sikapa-tap absolute right-1 top-1/2 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-lg text-sikapa-text-muted hover:bg-black/[0.04] dark:text-zinc-500 dark:hover:bg-white/10 dark:hover:text-zinc-200"
