...
export function HomeProductCarouselCard({ product: p }: Props) {
  return (
    <article className="relative w-[158px] shrink-0 overflow-hidden rounded-[10px] bg-white shadow-[0_2px_12px_rgba(59,42,37,0.06)] ring-1 ring-black/[0.05] transition-shadow hover:shadow-md dark:bg-zinc-900 dark:ring-white/10">
