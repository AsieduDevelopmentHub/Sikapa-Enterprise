...
const String _paystackReturnUrl = 'https://$_paystackReturnHost/checkout-complete';
  ...
  Future<void> _placeOrderAndPay() async {
    ...
    try {
      ...
      final order = await orders.create({
        ...
        if ((user.shippingLandmark ?? '').isNotEmpty) 'shipping_landmark': user.shippingLandmark,
      ...
      if (reference != null && reference.isNotEmpty) {
        ...
        } catch (_) {/* server webhook will reconcile */}
      }
        ...
        data: (cart) {
          ...
          return ListView(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              ...cart.items.map((l) => Padding(
                    padding: const EdgeInsets.symmetric(vertical: 6),
                    child: Row(
                      children: [
                        Expanded(child: Text('${l.product?.name ?? '#${l.productId}'} × ${l.quantity}')),
              ...
              Text('Shipping is added by the server based on your region.',
