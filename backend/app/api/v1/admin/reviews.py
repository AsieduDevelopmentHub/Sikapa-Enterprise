...
from app.api.v1.reviews.schemas import ReviewWithMediaSchema
from app.api.v1.reviews.services import serialize_reviews_with_media
...
@router.get("/", response_model=List[ReviewWithMediaSchema])
